...
public class ThreadExample implements Runnable {
	...
	public ThreadExample(Object mo, boolean isWaiter){
	...
	public static void main(String ar[]) throws InterruptedException {
		...
		ThreadExample thread1= new ThreadExample(objectMonitor, true);
		ThreadExample thread2 = new ThreadExample(objectMonitor, false);
